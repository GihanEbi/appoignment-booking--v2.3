...
const allAppointmentSchema = new Schema<IAppointment>(
  {
...
export default mongoose.models.all_appointments ||
  mongoose.model<IAppointment>("all_appointments", allAppointmentSchema);
